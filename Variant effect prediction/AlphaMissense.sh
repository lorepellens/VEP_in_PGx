...
singularity exec -B ${VEP_DIR}:/data ${VEP_SIF} \
    vep --dir data \
        ...
        --plugin AlphaMissense,file=/lustre1/project/stg_00156/thesis_projects_2025/lorepellens/vep/AlphaMissense_DATA/AlphaMissense_hg38.tsv.gz\
        --output_file /lustre1/project/stg_00156/thesis_projects_2025/lorepellens/vep/output_AlphaMissense.vcf 
