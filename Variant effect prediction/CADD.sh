...
VEP_DIR=/lustre1/project/stg_00156/thesis_projects_2025/lorepellens/ # VEP data directory

singularity exec -B ${VEP_DIR}:/data ${VEP_SIF} \
    vep --dir data \
        --dir_cache /lustre1/project/stg_00156/thesis_projects_2025/lorepellens/vep \
        ...
        --plugin CADD,/lustre1/project/stg_00156/thesis_projects_2025/lorepellens/vep/CADD_DATA/whole_genome_SNVs.tsv.gz,/lustre1/project/stg_00156/thesis_projects_2025/lorepellens/vep/CADD_DATA/gnomad.genomes.r4.0.indel.tsv.gz \
        --output_file /lustre1/project/stg_00156/thesis_projects_2025/lorepellens/vep/output_CADD.vcf 
